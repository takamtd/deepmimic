...
def update_world(world, time_elapsed):
  ...
  # reward = world.env._humanoid.calcMaxReward()
  # global max_reward
  # max_reward += reward
  # global total_reward
  # total_reward += reward
  global steps
  steps+=1
  # print(world.agents[0]._enable_training)
  # print("sim_model")
  # print(world.env._pybullet_client.getBasePositionAndOrientation(world.env._humanoid._sim_model))
  # print("kin_model")
  # print(world.env._pybullet_client.getBasePositionAndOrientation(world.env._humanoid._kin_model))
  # while True:
  #   pass
  # print("reward=",reward)
  # print("steps=",steps)
